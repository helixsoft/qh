<div class="hover-cont" id="hover-cont4" style="display:none;" >
...
?>
          ...
          <div class="blog-arrow"> 
                ...
                <a href="#" class="blog-arrow-left btn-left-menu-top-pick4"></a> 

                <a href="#" class="blog-arrow-right btn-right-menu-top-pick4"></a> 
  ...
  <!---Top Pick Slider--->
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#slider_menu_top_pick4").FlowSlider({
