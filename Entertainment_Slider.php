<div class="hover-cont" id="hover-cont" style="display:none;" >
...
?>
               ...
               <?php endforeach; ?>
                ...
                <a href="#" class="blog-arrow-left btn-left-menu-top-pick1"></a> 

                <a href="#" class="blog-arrow-right btn-right-menu-top-pick1"></a> 
...
?>
          ...
          <div class="blog-arrow"> 
                ...
                <a href="#" class="blog-arrow-left btn-left-menu-top-pick"></a> 

                <a href="#" class="blog-arrow-right btn-right-menu-top-pick"></a> 
  ...
  <!---it happpened Slider--->
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#slider_menu_top_pick").FlowSlider({
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#slider_menu_top_pick1").FlowSlider({
