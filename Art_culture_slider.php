<div class="hover-cont" id="hover-cont2" style="display:none;" >
...
?>      
        ...
        <div class="hover-pic"><img src="<?php echo $img_path; ?>" height="148" width="240"></div>
...
?>
          ...
          <div class="blog-arrow"> 
                ...
                <a href="#" class="blog-arrow-left btn-left-menu-top-pick2"></a> 

                <a href="#" class="blog-arrow-right btn-right-menu-top-pick2"></a> 
  ...
  <!---Top Pick Slider--->
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#slider_menu_top_pick2").FlowSlider({
