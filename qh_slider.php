<div class="hover-cont" id="hover-cont5" style="display:none;" >
...
?>
          ...
          <div class="blog-arrow"> 
                ...
                <a href="#" class="blog-arrow-left btn-left-menu-top-pick5"></a> 

                <a href="#" class="blog-arrow-right btn-right-menu-top-pick5"></a> 
  ...
  <!---Top Pick Slider--->
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#slider_menu_top_pick5").FlowSlider({
